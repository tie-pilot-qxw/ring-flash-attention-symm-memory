...
from ring_flash_attn import ring_flash_attn_symm_direct_func
...
if __name__ == "__main__":
    ...
    k_hdl_list = symm_mem.rendezvous(local_k, dist.group.WORLD)
    v_hdl_list = symm_mem.rendezvous(local_v, dist.group.WORLD)
    ...
    fn = ring_flash_attn_symm_direct_func
